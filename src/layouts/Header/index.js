  ...
  return (
    <header className="header">
      ...
      <section className="headerTwo">
        <input value ={searchInput} className={!searchToggle ? "search searchHide" : "search"}  onChange = {(e)=>takeSearchInput(e)} placeholder="Search..." />
        <span  className ="abort" onClick={()=>closeSearchBar()}>{searchInput !== "" && <HiX/>}</span>
        </section>
